...
- **Множественные провайдеры**: Groq, Hugging Face, Ollama, Together AI, Cohere
...
```bash
# Groq API (рекомендуется для сетевого окружения)
GROQ_API_KEY=your_groq_api_key_here

# Hugging Face (работает без токена, но с ограничениями)
HUGGINGFACE_TOKEN=your_token_here

# Together AI (опционально)
...
**Cohere (опционально):**
1. Зарегистрируйтесь на [dashboard.cohere.ai](https://dashboard.cohere.ai)
2. Перейдите в раздел API Keys
3. Создайте новый ключ
4. Добавьте в `.env.local`
...
**AI/Backend:**
- ⚡ Groq - Сверхбыстрый провайдер ИИ (до 30 раз быстрее)
